...
from api.src.schemas.schemas import ShortTermCashInvestmentsDBSchema
from api.src.services.dts_table_base_service import DTSBaseService


class ShortTermCashInvestmentsService(DTSBaseService):
    ...
    def get_data(self, filters):
        ...
        serialized_items = [
            ShortTermCashInvestmentsDBSchema.model_validate(item) for item in data
        ]
