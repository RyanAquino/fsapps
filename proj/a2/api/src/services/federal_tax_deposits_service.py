...
from api.src.schemas.schemas import FederalTaxDepositsDBSchema
from api.src.services.dts_table_base_service import DTSBaseService


class FederalTaxDepositsService(DTSBaseService):
    ...
    def get_data(self, filters):
        ...
        serialized_items = [
            FederalTaxDepositsDBSchema.model_validate(item) for item in data
        ]
