...
from api.src.schemas.schemas import DebtSubjectToLimitDBSchema
from api.src.services.dts_table_base_service import DTSBaseService


class DebtSubjectToLimitService(DTSBaseService):
    ...
    def get_data(self, filters):
        ...
        serialized_items = [
            DebtSubjectToLimitDBSchema.model_validate(item) for item in data
        ]
