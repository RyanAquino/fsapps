...
from api.src.schemas.schemas import PublicDebtTransactionsDBSchema
from api.src.services.dts_table_base_service import DTSBaseService


class PublicDebtTransactionsService(DTSBaseService):
    ...
    def get_data(self, filters):
        ...
        serialized_items = [
            PublicDebtTransactionsDBSchema.model_validate(item) for item in data
        ]
