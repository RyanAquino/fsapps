...
from api.src.schemas.schemas import AdjustmentPublicDebtTransactionsCashBasisDBSchema
from api.src.services.dts_table_base_service import DTSBaseService


class AdjustmentPublicDebtTransactionsCashBasisService(DTSBaseService):
    ...
    def get_data(self, filters):
        ...
        serialized_items = [
            AdjustmentPublicDebtTransactionsCashBasisDBSchema.model_validate(item)
            for item in data
        ]
